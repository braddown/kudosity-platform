...
export const segmentsApi = {
  ...
  getSystemSegments: (): Segment[] => {
    return [
      {
        id: "system-suppressed",
        name: "Suppressed",
        description: "Profiles that have been suppressed from marketing",
        type: "Custom", // Changed from "System" to "Custom"
        filter_criteria: {
          conditions: [
            {
              field: "tags",
      ...
      {
        id: "system-unsubscribed",
        name: "Unsubscribed",
        description: "Profiles that have unsubscribed from communications",
        type: "Custom", // Changed from "System" to "Custom"
        filter_criteria: {
          conditions: [
            {
      ...
      {
        id: "system-wrong-number",
        name: "Wrong Number",
        description: "Profiles with incorrect phone numbers",
        type: "Custom", // Changed from "System" to "Custom"
        filter_criteria: {
          conditions: [
            {
      ...
      },
      {
        id: "system-test-list",
        name: "Test List",
        description: "Test profiles for campaign testing",
        type: "Custom", // Changed from "System" to "Custom"
        filter_criteria: {
          conditions: [
            {
      ...
      },
      {
        id: "system-operators",
        name: "Operators",
        description: "System operators and administrators",
        type: "Custom", // Changed from "System" to "Custom"
        filter_criteria: {
          conditions: [
            {
