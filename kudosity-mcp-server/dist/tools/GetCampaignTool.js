...
export class GetCampaignTool {
    ...
    formatSingleCampaign(campaign, campaignId) {
    ...
    getStatusEmoji(status) {
        ...
        if (statusLower.includes('sent') || statusLower.includes('completed'))
            return '✅.js';
        if (statusLower.includes('sending') || statusLower.includes('active'))
            return '📤.js';
        if (statusLower.includes('pending') || statusLower.includes('scheduled'))
            return '⏳.js';
        if (statusLower.includes('failed') || statusLower.includes('error'))
            return '❌.js';
        if (statusLower.includes('paused') || statusLower.includes('stopped'))
            return '⏸️.js';
...
//# sourceMappingURL=GetCampaignTool.js.map