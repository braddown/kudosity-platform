 ...
 */
export function validateSMSMessage(message: string): { isValid: boolean; info: any; error?: string } {
  if (!message) {
 ...
 * Validate sender ID
 */
export function validateSenderID(sender?: string): { isValid: boolean; error?: string } {
  if (!sender) {
 ...
 */
export function validateWebhookEvents(events: string[]): { isValid: boolean; error?: string } {
